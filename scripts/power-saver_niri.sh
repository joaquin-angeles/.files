...
if [ -z "$NIRI_SOCKET" ]; then
    echo "Niri is not running. Exiting."
    exit 1
fi
...
MONITOR=$(niri msg outputs | awk '/Output/ {print $2}' | head -n 1)
