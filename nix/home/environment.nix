    ...
    xdg.mimeApps = {
        ...
        defaultApplications = lib.mkMerge [
            ...
            (mkMime editor [
                ...
                "application/x-yaml" "application/x-shellscript"
                "text/x-rust"       "text/x-csrc"           "text/x-chdr"
                "text/x-c++"        "text/x-c++hdr"         "text/x-python"
                "text/x-java"       "text/x-go"             "text/x-kotlin"
                "text/x-php"        "text/x-ruby"           "text/x-sql"
            ])
            (mkMime archive [
